...
//    if(params.employeeid = (authService.getEmployeeId()).toLong())

    static allowedMethods = [save: "POST", update: "PUT", delete: "DELETE"]

    def index(Integer max) {
        params.max = Math.min(max ?: 10, 100)
        respond customersService.list(params as Map), model:[customersCount: customersService.count()]
    }
    ...
    def create() {
        respond new Customers(params as Map)
    }
